...
public class NavigationDrawerAdapter2 extends RecyclerView.Adapter<NavigationDrawerAdapter2.MyViewHolder> {
    List<NavDrawerItem> data = Collections.emptyList();
    private LayoutInflater inflater;
    private Context context;

    public NavigationDrawerAdapter2(Context context, List<NavDrawerItem> data) {
